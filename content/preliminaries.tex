...
\todo[inline]{paragraph about UNA, ontological motivation, an individual name is supposed to
  represent an individual. It is not only a tag. It is its identity in an ontological sense. }
...
Again as usual in description logics, we use $C \equiv D$ (concept equivalence) as abbreviation
for $(C \sqsubseteq D) \land (D \sqsubseteq C)$ and $\Bmc_1\lor\Bmc_2$ (axiom disjunction) as
