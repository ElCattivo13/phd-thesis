...
\begin{table}[t]
  ...
  \begin{tabularx}{1.0\linewidth}[t]{clC@{\ }C@{\ }C@{\ }C}
    ...
    % \EL    & constant & \multicolumn{2}{c}{\cellcolor[gray]{0.9}} & \cellcolor[gray]{0.8}\\
    % \ALC   & \multicolumn{3}{c}{\cellcolor[gray]{0.9}}            & \cellcolor[gray]{0.8}\\
    % \SHOQ  & \multicolumn{3}{c}{\multirow{-2}{*}{\cellcolor[gray]{0.9} \ExpTime-complete}} & \cellcolor[gray]{0.8}\\
    % \SHOIQ &\multicolumn{3}{c}{\cellcolor[gray]{0.8}} & \multirow{-4}{*}{\cellcolor[gray]{0.8} \NExpTime-complete} \\
    \multirow{4}{*}{\rotatebox[origin=c]{90}{Setting (i)}}
    & \EL    & constant \\ \noalign{\hbox{\tikzmark{rawY2}}}
    & \ALC   &          \\ \noalign{\hbox{\tikzmark{rawY3}}}
    & \SHOQ  &          \\ \noalign{\hbox{\tikzmark{rawY4}}}
    & \SHOIQ & \tikzmark{X1l}\hfill\tikzmark{X1r}
             & \tikzmark{X2l}\hfill\tikzmark{X2r}
             & \tikzmark{X3l}\hfill\tikzmark{X3r}
             & \tikzmark{X4l}\hfill\tikzmark{X4r} \\ \noalign{\hbox{\tikzmark{rawY5}}}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \fill[gray!30] (X2l|-Y1) -- (X2l|-Y2) -- (X1l|-Y2) -- (X1l|-Y4a) -- (X3r|-Y4a) -- (X3r|-Y1) -- cycle;
  \fill[gray!60] (X4l|-Y1) -- (X4l|-Y4b) -- (X1l|-Y4b) -- (X1l|-Y5) -- (X4r|-Y5) -- (X4r|-Y1) -- cycle;
  ...
  \fill[gray!60] (X2l|-Y6) -- (X2l|-Y7) -- (X1l|-Y7) -- (X1l|-Y10) -- (X4r|-Y10) -- (X4r|-Y6) -- cycle;
  ...
  \fill[gray!100] (X2l|-Y11) -- (X2l|-Y14a) -- (X3r|-Y14a) -- (X3r|-Y11) -- cycle;
  \fill[gray!60] (X1l|-Y12) -- (X1l|-Y14a) -- (X1r|-Y14a) -- (X1r|-Y12) -- cycle;
  \draw[draw=gray!60, pattern=north east lines, pattern color=gray!50] (X4l|-Y11) -- (X4l|-Y14b) --
  (X1l|-Y14b) -- (X1l|-Y15) -- (X4r|-Y15) -- (X4r|-Y11) -- cycle;
...
\begin{proof}
  ...
  \end{align*}
  It is not hard to verify \todo{just do it} (using arguments of~\cite{Lip-PhD14}) that \Xmc is
...
Together with the lower bounds shown in Section~\ref{sec:case-el}, we obtain \NExpTime-completeness
for the consistency problem in \LMLO for \LM and \LO being DLs between \ALC and \SHOQ if
$\OCR \neq \emptyset$ and $\ORR = \emptyset$.
...
%  LocalWords:  Löwenheim Skolem Logics logics iff temporalized
