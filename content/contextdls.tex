...
\Bmfb explicit.  It is proved by induction on the structure of~\Bmc.
...
\begin{proof}
  ...
  \RM. Thus, it is only left to show that for any m-axiom $\gamma$ occurring in \Bmc, it holds that
