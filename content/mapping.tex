...
assertions which should additionally be satisfied by an \SCROI.
...
\begin{definition}[Constraint Set]
  ...
  \item All top-level \rosirole groups must be satisfied, i.e.\ if an object $o$ plays an \rt-role and
    ...
    \end{align*}
  \item All cardinality constraints are respected, i.e.\ every \rosirole that is played in a compartment
