...
\todo[inline]{restrictions on mapping
  ...
  \protect\item compartments that play roles
  \protect\end{itemize}
}
...
\begin{align}
\intertext{Every context belongs to exactly one compartment type.}
...
\intertext{In every context, every natural and every \rosirole belongs to exactly one type.}
...
\begin{align}
  ...
  play which \rosirole types. Hence, all \plays-successors of naturals of a specific natural type are either instances of a
...
%\todo{details}\todo{explain dl role \counts}
}
...
Some explanation about intra constraints, and that they cannot be expressed.
