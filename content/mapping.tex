...
description logics it will be tedious and error-prone to manually construct the DL ontology which
exactly captures a role-based model, especially since the domain analyst who generates the
